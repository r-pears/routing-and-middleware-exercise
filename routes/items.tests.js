...
let items = require('../fakeDatabase');
let item = { name: 'dummy', price: 200 };
...
describe("GET /items/:name", async function () {
  ...
  test("Responds with 404 if you can't find item", async function () {
...
describe("POST /items", async function () {
  test("Creates a new item", async function () {
    ...
    expect(response.body.item.name).toEqual('Donut');
